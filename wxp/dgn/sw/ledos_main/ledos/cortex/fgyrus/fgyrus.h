...
#define FGYRUS_FFT_LEN			128

#define	FGYRUS_REG_BASE			0x10000
#define	FGYRUS_FFT_CACHE_BASE	0x11000
#define	FGYRUS_TWDL_RAM_BASE	0x12000
#define	FGYRUS_CORDIC_RAM_BASE	0x13000
#define	FGYRUS_WIN_RAM_BASE		0x14000
...
#define	FGYRUS_CTRL_REG_ADDR		0x10000
#define	FGYRUS_STATUS_REG_ADDR		0x10010
#define	FGYRUS_POST_NORM_REG_ADDR	0x10020
...
#define FGYRUS_FFT_DONE_MSK		0x8
#define	FGYRUS_POST_NORM_MSK	0xf

//Read Fgyrus fields
#define	IORD_FGYRUS_CTRL			\
		IORD_32DIRECT(CORTEX_BASE, FGYRUS_CTRL_REG_ADDR)

#define	IORD_FGYRUS_STATUS			\
		IORD_32DIRECT(CORTEX_BASE, FGYRUS_STATUS_REG_ADDR)

#define	IORD_FGYRUS_POST_NORM			\
		IORD_32DIRECT(CORTEX_BASE, FGYRUS_POST_NORM_REG_ADDR)

//Write Fgyrus fields
#define	IOWR_FGYRUS_CTRL(data)		\
		IOWR_32DIRECT(CORTEX_BASE, FGYRUS_CTRL_REG_ADDR, data)

#define	IOWR_FGYRUS_POST_NORM(data)		\
		IOWR_32DIRECT(CORTEX_BASE, FGYRUS_POST_NORM_REG_ADDR, data)
