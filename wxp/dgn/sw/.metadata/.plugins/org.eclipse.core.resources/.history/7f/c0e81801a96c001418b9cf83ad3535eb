...
#define	SSM2603_DRVR_MCLK_SEL_REG_ADDR  0x01040
...
#define	IORD_SSM2603_DRVR_MCLK_SEL				\
		IORD_32DIRECT(CORTEX_BASE, SSM2603_DRVR_MCLK_SEL_REG_ADDR)
...
#define	IOWR_SSM2603_DRVR_MCLK_SEL(data)		\
		IOWR_32DIRECT(CORTEX_BASE, SSM2603_DRVR_MCLK_SEL_REG_ADDR, data)
