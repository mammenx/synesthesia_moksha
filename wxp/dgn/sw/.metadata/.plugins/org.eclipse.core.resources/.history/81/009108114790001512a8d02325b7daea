...
struct hdmi_encoder adv7513_encoder;

alt_u8 adv7513_edid[256];
...
#define GET_HDMI_IRQ_STATUS \
		IORD_ALTERA_AVALON_PIO_EDGE_CAP(HDMI_TX_INT_N_BASE) & HDMI_TX_INT_MASK

#define CLEAR_HDMI_IRQ_FLAG \
		IOWR_ALTERA_AVALON_PIO_EDGE_CAP(HDMI_TX_INT_N_BASE, 0x00)

#define DISABLE_HDMI_IRQ \
		alt_ic_irq_disable(HDMI_TX_INT_N_IRQ_INTERRUPT_CONTROLLER_ID, HDMI_TX_INT_N_IRQ)

#define REGISTER_HDMI_ISR(ec,isr) \
		alt_ic_isr_register(HDMI_TX_INT_N_IRQ_INTERRUPT_CONTROLLER_ID, HDMI_TX_INT_N_IRQ, isr, ec, NULL)

#define ENABLE_HDMI_IRQ \
		IOWR_ALTERA_AVALON_PIO_IRQ_MASK(HDMI_TX_INT_N_BASE, HDMI_TX_INT_MASK); \
		alt_ic_irq_enable(HDMI_TX_INT_N_IRQ_INTERRUPT_CONTROLLER_ID, HDMI_TX_INT_N_IRQ)


extern void adv7513_int_handler(void *context);
extern int adv7513_int_setup(struct hdmi_encoder *ec, const struct adv7513_int_mask *mask, alt_isr_func isr);

extern int adv7513_init();
