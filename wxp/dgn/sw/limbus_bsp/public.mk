...
# setting BSP_SYS_LIB is chibios_v268_bsp
BSP_SYS_LIB := chibios_v268_bsp
ELF_PATCH_FLAG  += --thread_model chibios_v268

# Type identifier of the BSP library 
# setting BSP_TYPE is chibios_v268
ALT_CPPFLAGS += -D__hal__
BSP_TYPE := chibios_v268
...
ALT_INCLUDE_DIRS += $(ALT_LIBRARY_ROOT_DIR)/ChibiOS_v268/kernel/include
ALT_INCLUDE_DIRS += $(ALT_LIBRARY_ROOT_DIR)/ChibiOS_v268/ports/GCC/NiosII
ALT_INCLUDE_DIRS += $(ALT_LIBRARY_ROOT_DIR)/ChibiOS_v268/./
