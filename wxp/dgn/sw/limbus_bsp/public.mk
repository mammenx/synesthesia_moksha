...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../syn/limbus.sopcinfo
...
# setting BSP_SYS_LIB is chibios_v246_bsp
BSP_SYS_LIB := chibios_v246_bsp
ELF_PATCH_FLAG  += --thread_model chibios_v246

# Type identifier of the BSP library 
# setting BSP_TYPE is chibios_v246
ALT_CPPFLAGS += -D__hal__
BSP_TYPE := chibios_v246
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x201040
SOPC_SYSID_FLAG += --sidp=0x201040
ELF_PATCH_FLAG  += --sidp 0x201040

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1415787611
SOPC_SYSID_FLAG += --timestamp=1415787611
ELF_PATCH_FLAG  += --timestamp 1415787611
...
ALT_INCLUDE_DIRS += $(ALT_LIBRARY_ROOT_DIR)/ChibiOS_v246/kernel/include
ALT_INCLUDE_DIRS += $(ALT_LIBRARY_ROOT_DIR)/ChibiOS_v246/ports/GCC/NiosII
ALT_INCLUDE_DIRS += $(ALT_LIBRARY_ROOT_DIR)/ChibiOS_v246/./
